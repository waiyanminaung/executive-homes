...
export type ApiSchema = {
  ...
  "properties": {
    GET: {
      ...
      query?: { page?: string; limit?: string; isForSale?: string; isForRent?: string; type?: string; provinceId?: string; districtId?: string; subDistrictIds?: string; isPetFriendly?: string; beds?: string; q?: string; sort?: string; stationIds?: string };
    };
  };
  "properties/:slug": {
