...
export const PROPERTY_DETAIL: PropertyDetail = {
  ...
  detailStats: [
    ...
    { label: "Property Size", value: "338 sqm", icon: Maximize2 },
  ...
  commonFacilities: [
    ...
    { label: "Security / CCTV", icon: Camera },
    { label: "Shuttle service", icon: Bus },
    { label: "Swimming pool", icon: Waves },
    { label: "Gym / Fitness", icon: Dumbbell },
    { label: "Garden", icon: Leaf },
    { label: "Kid's playground", icon: Baby },
    { label: "Tennis court / Squash room", icon: Trophy },
    { label: "Steam room / Sauna room", icon: Flame },
