  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
        <h3 className="text-sm font-semibold text-gray-900">{editing ? "Edit Feature" : "Add Feature"}</h3>
...
export default function AdminFeaturesPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {showForm && (
        <FeatureForm editing={editing} onSaved={handleSaved} onCancel={handleCancel} />
      )}
              ...
              <tbody className="divide-y divide-gray-100">
                {features.map((feature) => (
                  <tr key={feature.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 font-mono">{feature.slug}</td>
