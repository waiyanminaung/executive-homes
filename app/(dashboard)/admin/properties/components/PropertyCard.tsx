...
export default function PropertyCard({ property, selected, onToggle, onDelete }: Props) {
  ...
  return (
    <div className={classNames("p-4 transition-colors", selected && "bg-primary-50")}>
      <div className="flex items-start gap-3">
        <Checkbox checked={selected} onChange={() => onToggle(property.id)} className="mt-0.5 shrink-0" />
