...
export const PK_PLAYER_CENTER_FEEDBACK_MS = 650;
...
export const PK_PLAYER_DEFAULT_VOLUME = 0.5;

export const PK_PLAYER_THEME_COLOR = "#e50914";

export const PK_PLAYER_PLAYBACK_RATES = [0.5, 0.75, 1, 1.25, 1.5] as const;

const VIDEO_TEST_STREAM_SRC = process.env.NEXT_PUBLIC_VIDEO_TEST_STREAM_SRC ?? "";
